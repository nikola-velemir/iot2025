    ...
    peripherals: PeripheralTabularView[] = [
      {
        ...
        grafanaUrl: "http://localhost:3000/d-solo/ddaacbac-473a-4982-a690-9c22cd365de1/pi1?orgId=1&from=1771026149116&to=1771026449116&timezone=browser&refresh=10s&panelId=panel-2&__feature.dashboardSceneSolo=true"
      },
      {
        name: 'DPIR1', type: 'Motion sensor', peripheralType: 'Sensor',
        currentState: computed(() => this.globalState.data().pi1.dpir1),
        grafanaUrl: "http://localhost:3000/d-solo/ddaacbac-473a-4982-a690-9c22cd365de1/pi1?orgId=1&from=1771026139116&to=1771026439116&timezone=browser&refresh=10s&panelId=panel-4&__feature.dashboardSceneSolo=true"
      },
      {
        name: 'DUS1', type: 'Ultrasonic sensor', peripheralType: 'Sensor',
        currentState: computed(() => this.globalState.data().pi1.dus1),
        grafanaUrl: "http://localhost:3000/d-solo/ddaacbac-473a-4982-a690-9c22cd365de1/pi1?orgId=1&from=1771026119116&to=1771026419116&timezone=browser&refresh=10s&panelId=panel-1&__feature.dashboardSceneSolo=true"
      },
      {
      ...
      },
      {
        ...
        grafanaUrl: "http://localhost:3000/d-solo/ddaacbac-473a-4982-a690-9c22cd365de1/pi1?orgId=1&from=1771026059116&to=1771026359116&timezone=browser&refresh=10s&panelId=panel-3&__feature.dashboardSceneSolo=true"
      },
      {
      ...
      },
      {
        ...
        grafanaUrl: "http://localhost:3000/d-solo/ddaacbac-473a-4982-a690-9c22cd365de1/pi1?orgId=1&from=1771025928819&to=1771026228819&timezone=browser&refresh=10s&panelId=panel-5&__feature.dashboardSceneSolo=true"
      },
    ];
}
